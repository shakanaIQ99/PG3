...
int main()
{
    ...
    while (1)
    {
        ...
        if (state == State::INPUT)
        {
            ...
            cout << "—v‘f‚ğ’Ç‰Á‚·‚éêŠ‚ğw’è‚µ‚Ä‚­‚¾‚³‚¢B" << endl;
            cout << "ÅŒã”ö‚É’Ç‰Á‚·‚éê‡‚Í‰½‚à“ü—Í‚µ‚È‚¢‚Å‚­‚¾‚³‚¢B" << endl;
            cin.clear();
            cin.ignore(1024, '\n');
            getline(cin, input); 

            cout << "’Ç‰Á‚·‚é—v‘f‚ğ“ü—Í‚µ‚Ä‚­‚¾‚³‚¢B" << endl;
            cin >> str;
            if (input == string(""))
            {
            ...
            if (state == State::EDIT)
            {
                ...
                cout << "—v‘f‚ğ•ÒW‚·‚éêŠ‚ğw’è‚µ‚Ä‚­‚¾‚³‚¢B" << endl;
                ...
                if (stoi(input) >= Liststr.size() || stoi(input) < 0)
                {
                    ...
                    cout << "•ÒWŒã‚Ì—v‘f‚ğ“ü—Í‚µ‚Ä‚­‚¾‚³‚¢B" << endl;
                    cin >> str;
            ...
            if (state == State::DEL)
            {
                ...
                cout << "—v‘f‚ğíœ‚·‚éêŠ‚ğw’è‚µ‚Ä‚­‚¾‚³‚¢B" << endl;
